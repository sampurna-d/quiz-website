...
/**
 * Broken Window Quiz Data
 * Questions and results for identifying which "broken window" type best describes a person
 */
export const brokenWindowQuiz: QuizDataType = {
  questions: [
    // Question 1
    {
      id: 1,
